function drawGame() {
  ...
  window.addEventListener("gamepadconnected", (e) => {
    ...
    setInterval(() => {
      ...
      if (axe1 >= 0.7) {
        xAxis = 1; // Droite
        turgutImage.src = "../imagesOfTurgut/Layer 1_sprite_8.png";
        counterWalk++;
      } else if (axe1 <= -0.7) {
        xAxis = -1; // Gauche
        turgutImage.src = "../imagesOfTurgut/Layer 1_sprite_10.png";
        counterWalk++;
      } else {
        xAxis = 0; // Aucun mouvement horizontal
        turgutImage.src = "../imagesOfTurgut/Layer 1_sprite_2.png";
      }
